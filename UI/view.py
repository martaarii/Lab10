...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        # Row 2
        self._txtStato = ft.Dropdown(label="Stato",options= [])
        self._controller.popolaTendina()
        self._btnStatiVicini = ft.ElevatedButton(text="Stati confinanti",
                                                 on_click=self._controller.handleStatiConfinanti)
        row2 = ft.Row([self._txtStato, self._btnStatiVicini], alignment=ft.MainAxisAlignment.CENTER)
